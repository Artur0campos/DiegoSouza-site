...
import { Users, ExternalLink, Clock, BookMarked } from 'lucide-react';
import { useInView } from '@/hooks/useInView';
import { MateriaCelula } from '@/data/materias-celula';

interface MateriaCardProps {
  materia: MateriaCelula;
  index: number;
}

export function MateriaCard({ materia, index }: MateriaCardProps) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="relative group">
          ...
          <div className="relative w-[220px] h-[300px] sm:w-[260px] sm:h-[360px] md:w-[300px] md:h-[420px] rounded-lg overflow-hidden shadow-2xl group-hover:shadow-[0_25px_60px_rgba(9,55,51,0.3)] transition-all duration-500 group-hover:-translate-y-2 bg-[#093733] flex flex-col items-center justify-center gap-4 border-2 border-dashed border-[#26BDB0]/40">
            <BookMarked className="w-10 h-10 text-[#26BDB0]/60 stroke-[1.25]" />
            ...
            <span className="mt-2 inline-block px-3 py-1 text-[10px] font-montserrat tracking-[0.15em] uppercase bg-[#26BDB0]/20 text-[#26BDB0]/90 rounded-full">
              {materia.tema}
            </span>
          </div>
        </div>
      ...
      >
        ...
        <div className="flex items-center gap-6 mb-8 font-montserrat text-xs text-[#093733]/50">
