    ...
    <section className="relative w-full min-h-[60vh] md:min-h-[70vh] flex flex-col justify-center items-center overflow-hidden text-[#093733]">
      ...
      <div className="max-w-4xl mx-auto px-6 sm:px-8 text-center flex flex-col items-center pt-16 pb-8 z-10">
        ...
        <h1 className="font-alan font-light text-4xl sm:text-5xl md:text-6xl lg:text-7xl tracking-tight mb-6">
          <span className="text-[#093733]">Palestras</span>{' '}
          <span className="text-[#26BDB0]">&</span>{' '}
          <span className="text-[#093733]">Pregações</span>
        </h1>
        ...
        <p className="font-montserrat font-light text-base sm:text-lg md:text-xl text-[#093733]/80 leading-relaxed max-w-2xl">
          Mensagens que integram fé, direito e propósito. Assista às palestras e
          pregações do Dr. Diego Bruno diretamente aqui, sem sair da página.
        </p>
      </div>
    </section>
  );
